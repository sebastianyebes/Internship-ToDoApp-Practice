...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Hei_5iCMTfR/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: bDZsY2ejrcT/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: EgOvhs2oNaP/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__yByPq)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__r9GYc)}
                role={"img"}
              />
            ),
